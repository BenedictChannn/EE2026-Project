...
#
# Generated by export_simulation on Sun Oct 08 22:25:02 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_img.sh' script.

./blk_mem_gen_img.sh -reset_run
...
./blk_mem_gen_img.sh -noclean_files

For more information on the script, please type './blk_mem_gen_img.sh -help'.
