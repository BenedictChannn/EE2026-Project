...
read_verilog -library xil_defaultlib {
  ...
  C:/Users/bened/OneDrive/Documents/EE2026-Project/MODS/MODS.srcs/sources_1/new/Brick_Breaker.v
}
...
synth_design -top Brick_Breaker -part xc7a35tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Brick_Breaker.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Brick_Breaker_utilization_synth.rpt -pb Brick_Breaker_utilization_synth.pb"
