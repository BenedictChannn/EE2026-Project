...
HD_PWD='C:/Users/bened/OneDrive/Documents/EE2026-Project/MODS/MODS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Integrate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Integrate.tcl
