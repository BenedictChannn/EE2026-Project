...
HD_PWD='C:/Users/bened/OneDrive/Documents/EE2026-Project/MODS/MODS.runs/blk_mem_gen_const_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_const.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_const.tcl
