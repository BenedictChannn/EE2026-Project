...
HD_PWD='C:/Users/bened/OneDrive/Documents/EE2026-Project/MODS/MODS.runs/blk_mem_gen_img_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_img.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_img.tcl
