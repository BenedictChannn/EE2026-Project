...
set rc [catch {
  ...
  open_checkpoint Integrate_routed.dcp
  ...
  catch { write_mem_info -force Integrate.mmi }
  write_bitstream -force Integrate.bit 
  catch {write_debug_probes -quiet -force Integrate}
  catch {file copy -force Integrate.ltx debug_nets.ltx}
